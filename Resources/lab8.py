...
''' GLOBAL VARIABLES '''
comPort = 'COM10' #change value to actual comPort Example -> 'COM6'
data1 = ['1', '2', '3', '4', '5', '6']
data2 = ['6', '5', '4', '3', '2', '1']
...
def plotTrace(dataToPlot, plotType):
	figs = plt.figure()	
	...
	plt.savefig(snapShotFile,dpi=100)
